...
const HW1: ChoiceStep = {
  ...
  context: (
    <div>
      ...
      <div className="rounded-xl overflow-hidden mb-4" style={{ border: "1px solid rgba(0,0,0,0.15)" }}>
      ...
      <p className="text-[13px] leading-[1.65]" style={{ color: "rgba(0,0,0,0.62)" }}>
        קראי את הפלט שורה-שורה. כל הלוחות הכושלים — <span className="font-bold" style={{ color: "#7c2d12" }}>מה משותף להם?</span>
      </p>
    </div>
  ),
  question: "מה הדפוס בפלט עמדת הבדיקה?",
  options: [
    "הלוחות נכשלים בבדיקות אקראיות — אין דפוס",
    "כל הכשלים באותה בדיקה בדיוק: מתח נמוך בפס ה-3.3V",
    "עמדת הבדיקה עצמה מקולקלת — לוח אחד עבר",
  ],
  correct: 1,
  okMsg: "מצוין! כל הכשלים ב-test 4 עם מתח נמוך באותו פס. כשל אקראי = בעיות שונות; כשל זהה = גורם אחד משותף. זה מצמצם את החיפוש דרמטית.",
  errMsg: "הסתכלי שוב: כל שלושת הכשלים הם test 4/12 עם 3.3V נמוך. דפוס זהה = גורם אחד. ועמדה מקולקלת הייתה מכשילה את כולם — אבל B-2230 עבר.",
  learned: "כשל זהה בכל הלוחות = גורם אחד משותף",
};
...
const HW3: ChoiceStep = {
  kind: "choice",
  tag: "בידוד אצווה",
  concept: "רכיבים מגיעים באצוות — וכך גם התקלות",
  context: (
    <div>
      <p className="text-[13.5px] leading-[1.7] mb-4" style={{ color: "rgba(0,0,0,0.62)" }}>
        שאלת "מה השתנה?" הובילה לתשובה: הבוקר הקו התחיל להשתמש
        באצוות רכיבים חדשות. הצלבת את הלוחות הכושלים מול האצוות:
      </p>
  ...
  correct: 1,
  okMsg: "בול! U-118 נמצא בכל הלוחות — אם הוא היה הבעיה, כולם היו נכשלים. C-4471 נמצאת רק ב-40 לוחות, וכל 6 הכשלים ביניהם. זה בידוד אצווה.",
  errMsg: "מורכבות ≠ אשמה. U-118 נמצא בכל 200 הלוחות אבל רק 6 נכשלו. אצוות הקבלים C-4471 נמצאת רק ב-40 לוחות — וכל הכשלים בדיוק שם.",
...
const HW4: MatchStep = {
  ...
  context: (
    <div>
      <p className="text-[13.5px] leading-[1.7] mb-4" style={{ color: "rgba(0,0,0,0.62)" }}>
        לפני אישור סופי — לוח כושל אחד נלקח למעבדה לאימות עם קבל מהאצווה החשודה.
  ...
  pairs: [
    { left: "מולטימטר", right: "כמה וולט יש בנקודה הזו עכשיו?" },
    { left: "אוסצילוסקופ", right: "איך המתח מתנהג לאורך זמן?" },
    { left: "בדיקה חזותית", right: "האם רואים נזק פיזי — קבל נפוח, לחמה סדוקה?" },
    { left: "החלפת רכיב מבוקרת", right: "אם מחליפים רק אותו — התקלה נעלמת?" },
  ],
  okMsg: "מושלם! ובמעבדה זה בדיוק מה שקרה: הקבל מהאצווה החשודה הוחלף בקבל תקין — והלוח עבר את כל 12 הבדיקות. האצווה אשמה, מאומת.",
  errMsg: "כמעט — מולטימטר נותן מספר רגעי, אוסצילוסקופ מראה התנהגות לאורך זמן, העין מוצאת נזק פיזי, והחלפה מבוקרת היא ההוכחה הסופית.",
  learned: "מספר רגעי | לאורך זמן | נזק פיזי | הוכחה בהחלפה",
};
