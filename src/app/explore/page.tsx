      ...
      <div className="flex justify-center min-h-screen" style={{ background: "#f2ede6" }}>
        <div className="w-full max-w-[390px] min-h-screen bg-card flex flex-col shadow-[0_20px_50px_rgba(2,62,138,0.16)]">
          ...
          <div className="bg-navy text-white px-[22px] pt-[26px] pb-[30px] shrink-0">
            ...
            <div className="text-[30px] leading-tight" style={HEEBO}>המסלול שלך</div>
          ...
          {/* First domain highlight */}
          <div className="px-[22px] pt-5 flex-1">
            <div className="text-[11.5px] font-bold mb-3 uppercase tracking-wide" style={{ color: "rgba(0,0,0,0.38)" }}>
              מתחילים עם
            </div>
            <div
              className="rounded-2xl p-4 flex items-center gap-4"
              style={{
                background: `${firstDomain.color}13`,
                border: `1.5px solid ${firstDomain.color}45`,
              }}
            >
              <div
          ...
          {/* CTA */}
          <div className="px-[22px] pb-28 pt-5">
            <Link
    ...
    <div className="flex justify-center min-h-screen" style={{ background: "#f2ede6" }}>
      <div className="w-full max-w-[390px] min-h-screen bg-card flex flex-col shadow-[0_20px_50px_rgba(2,62,138,0.16)]">
        ...
        <div className="bg-navy text-white px-[22px] pt-[26px] pb-[30px] shrink-0">
          ...
          <div className="text-[30px] leading-tight" style={HEEBO}>טעימות הייטק</div>
          <div className="text-[13.5px] mt-[6px]" style={{ opacity: 0.72 }}>
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      border: isRanked
                        ? `1.5px solid ${domain.color}55`
                        : "1px solid rgba(2,62,138,0.06)",
                      boxShadow: isRanked ? "none" : "0 2px 14px rgba(2,62,138,0.07)",
                    }}
                  >
                    {/* Top: badge + rank bubble */}
                    ...
                    {/* Name */}
                    <div className="text-[14.5px] text-navy leading-tight" style={HEEBO}>
                      {domain.label}
                    </div>

                    {/* Desc */}
                    <div className="text-[11.5px] leading-[1.5] flex-1" style={{ color: "rgba(0,0,0,0.45)" }}>
                      {domain.desc}
                    </div>
                    ...
                    <div
                      ...
                      style={{ color: isRanked ? domain.color : "rgba(0,0,0,0.22)" }}
                    >
        ...
        >
          <button
            ...
            style={{
              background: allRanked ? "#023e8a" : "rgba(2,62,138,0.22)",
