...
const TRACK_META: Record<Track, { emoji: string; label: string; duration: string; cost: string; entry: string; pros: string[]; cons: string[] }> = {
  bootcamp: {
    ...
    pros: [
      "טק-קריירה היא חינם לגמרי — כולל מלגת קיום ומגורים — עם 88–90 אחוזי השמה ובוגרים בצ׳ק פוינט, Wix, אינטל ובזק",
...
const BLOCKERS: Blocker[] = [
  {
    ...
    solutions: [
      { name: "תוכנית יואל — בר-אילן", detail: "המכינה המובילה בארץ לקהילה. תגבורים אישיים שבועיים, סדנאות, רכז/ת צמוד/ה ומלגת מעונות. המעטפת כאן היא מה שמבדיל בין להתחיל לבין לסיים.", link: "https://mechina-kda.biu.ac.il/Ethiopian_immigrants_in_academy" },
      { name: "נתיב לאקדמיה — בן-גוריון", detail: "כ-13 שבועות. הציון הסופי מחליף את הפסיכומטרי ופותח את כל המחלקות.", link: "https://www.bgu.ac.il/welcome/kdam/programs/nativ/" },
      { name: "הישגים / אלומה", detail: "ייעוץ אישי בחינם עוד לפני ההרשמה — איזו מכינה, איפה, ואיך מממנים אותה.", link: "https://hesegim.org.il/" },
    ],
  },
  {
    id: "money",
    ...
    lead: "יש הרבה יותר כסף לתארים מאשר לקורסים. הרבה יותר. אלה התוכניות שרלוונטיות לך, עם התאריכים.",
    solutions: [
