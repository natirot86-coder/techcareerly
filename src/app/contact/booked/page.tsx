...
const WHAT_HAPPENS: Record<MeetingNum, { emoji: string; text: string }[]> = {
  ...
  2: [
    ...
    { emoji: "🔍", text: "תעברו על הטעימות שעשית — מה אהבת, מה פחות, איפה את/ה מרגיש/ה שתצליח ולמה" },
    { emoji: "🗺️", text: "בסוף הפגישה תבחר/י תחום — אחרי שהתייעצת עם הרכזת. ואז היא תפתח איתך את השלב הבא: חקר מסלולי הלימוד, למצוא את המסלול הנכון לתחום שבחרת" },
  ],
  3: [
