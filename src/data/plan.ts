...
/*
   הקבוע עצמו יושב ב-scholarships.ts (28.8) כדי שמלגה שמכסה שנה
   מלאה תוכל להצביע עליו — plan.ts מייבא מ-scholarships, ולכן הכיוון
   ההפוך היה סוגר מעגל. מייצא מחדש כדי שאף יבואן לא יצטרך להשתנות.
*/
export { BUDGETED_TUITION } from "./scholarships";
