...
export const COURSES: Course[] = [
  ...
  {
    id: "biu-qa-ai",
    name: "בודק/ת תוכנה QA + כלי AI — בר-אילן",
    institutionId: "bar-ilan",
    link: "https://hitech-school.biu.ac.il/course/certified-qa-course",
    startsAt: "2026-10-22",
    city: "רמת גן",
    what: "קורס QA של בית הספר להייטק וסייבר של בר-אילן — ״נקודת פתיחה מצוינת לקריירה בהייטק, ללא ניסיון קודם״, עם תעודה אוניברסיטאית.",
    who: "בלי דרישת תואר או ניסיון",
    cost: "לא פורסם — 077-8040865",
    format: "200 שעות אקדמיות · כ-6 חודשים",
    catch: "המחיר לא שקוף באתר — לברר טלפונית לפני שמפנים.",
    domains: ["qa"],
    status: "active",
    notes: "📞 לאמת מחיר. נמצא במחקר 20.8.2026 — לחיילים משוחררים יש שם דף ייעודי עם מימון מהפיקדון.",
    verified: "2026-08-20 — hitech-school.biu.ac.il",
  },
  {
    id: "biu-cyber-cloud",
    name: "סייבר וארכיטקט ענן AWS — בר-אילן",
    institutionId: "bar-ilan",
    link: "https://hitech-school.biu.ac.il/course/cyber-course",
    startsAt: "2026-09-08",
    city: "רמת גן",
    what: "מסלול כפול — הגנת סייבר וענן AWS — עם שתי תעודות בסיום. היברידי.",
    who: "לא צוינה דרישת תואר",
    cost: "לא פורסם — 077-8040865. לחיילים משוחררים: מימון מהפיקדון",
    format: "400 שעות · כ-10 חודשים · היברידי",
    catch: "ארוך יחסית — 10 חודשים. המחיר לא שקוף.",
    domains: ["cyber", "networks"],
    status: "active",
    notes: "📞 לאמת מחיר ותנאי קבלה מדויקים.",
    verified: "2026-08-20 — hitech-school.biu.ac.il",
  },
  {
    id: "biu-ccna",
    name: "רשתות Cisco CCNA — בר-אילן",
    institutionId: "bar-ilan",
    link: "https://hitech-school.biu.ac.il/course/ccna-course",
    startsAt: "2026-10-13",
    city: "רמת גן",
    what: "הסמכת CCNA — כרטיס הכניסה הקלאסי לעולם הרשתות — בקורס קצר יחסית של בר-אילן.",
    who: "בלי דרישת רקע אקדמי",
    cost: "לא פורסם — 077-8040865",
    format: "85 שעות · כ-4 חודשים",
    catch: "הסמכה היא צעד ראשון — משרה ראשונה דורשת לרוב גם ניסיון מעבדה ביתי.",
    domains: ["networks"],
    status: "active",
    notes: "📞 לאמת מחיר.",
    verified: "2026-08-20 — hitech-school.biu.ac.il",
  ...
  {
    id: "biu-data-ai",
    name: "Data Science ו-Agentic AI — בר-אילן",
    institutionId: "bar-ilan",
    link: "https://hitech-school.biu.ac.il/course/data-science-course",
    startsAt: "2026-11-22",
    city: "רמת גן",
    what: "מסלול דאטה עם דגש על סוכני AI — התחום החם של השנה — בתעודת בר-אילן.",
    who: "תנאי קבלה לא פורסמו",
    cost: "לא פורסם — 077-8040865",
    format: "270 שעות · כ-7 חודשים",
    catch: "תנאי הקבלה לא פורסמו — ייתכן שנדרש רקע. לברר לפני.",
    domains: ["data", "ai"],
    status: "active",
    notes: "📞 לאמת מחיר ותנאי קבלה.",
    verified: "2026-08-20 — hitech-school.biu.ac.il",
  },
  {
    id: "technion-qa",
    name: "QA — בודקי תוכנה · לימודי המשך הטכניון",
    institutionId: "technion",
    link: "https://cont-edu.technion.ac.il/programs/מחשבים-והייטק/בודקי-תוכנה-tcqa/",
    what: "תעודת טכניון בלי דרישת תואר — בגרות מלאה בלבד + ראיון. אולי ההכשרה היוקרתית-נגישה ביותר שמצאנו.",
    who: "בגרות מלאה — בלי תואר ובלי ניסיון",
    cost: "לא פורסם — 073-3785050. מלגת 1,000 ₪ במסלול הבוקר",
    format: "ערב: כ-5 חודשים (ב׳+ה׳ 17:30–21:30) · בוקר: 3–4 חודשים",
    catch: "אין מחזור מפורסם באתר — המועד נקבע מול מרכז המידע.",
    domains: ["qa"],
    status: "active",
    notes: "📞 לאמת מחיר ומועד מחזור. נמצא במחקר 20.8.2026 — קיימים שם גם מיישמי סייבר ו-AI Full Stack בלי רקע.",
    verified: "2026-08-20 — cont-edu.technion.ac.il",
  },
  {
    id: "grtech-qa",
    name: "QA ואוטומציה — Google & Reichman Tech School",
    institutionId: "google-runi",
    link: "https://www.graitechschool.co.il/",
    what: "המסלול שהוקם במוצהר לפתוח את ההייטק לאוכלוסיות מגוונות: קבלה לפי פוטנציאל, בלי תואר, עם מלגות של 60–94% והשמה מובנית.",
    who: "18+, בסיס במתמטיקה/עברית/אנגלית — בלי ניסיון",
    cost: "מחיר מלא 44,150 ₪ — מלגות 60–94% לאוכלוסיות בתת-ייצוג (במחזור שדרות זכאי עוטף שילמו 2,650 ₪)",
    format: "6 חודשים · היברידי · מיון: שאלון, משימה, מבחן וראיון",
    catch: "המלגה תלויה בזכאות — בלי מלגה זה יקר מאוד. מועד המחזור הבא לא פורסם.",
    domains: ["qa"],
    status: "active",
    notes: "📞 לאמת מועד מחזור וזכאות מלגה לקהל שלנו. יש שם גם סייבר אנליסט ודאטה אנליסט.",
    verified: "2026-08-20 — graitechschool.co.il + runi.ac.il",
  },
];
