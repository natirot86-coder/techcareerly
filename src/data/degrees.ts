...
export const DEGREES: Degree[] = [
  ...
  },
  {
    ...
    status: "active",
    challenge: "לא הלימודים — המשרות. הן פחות נוצצות ופחות משלמות, ופיתוח כמעט סגור",
  ...
  },
  {
    ...
    caveat:
      "אין לנו נתוני שכר ותעסוקה לתואר הזה — עבודאטה לא מפרסמת פילוח להתמחויות, ולא מצאנו מקור אחר ברשת. **היעדר המספר אינו אומר שהתואר חלש**, ואי אפשר להשוות אותו למספרים שמופיעים ליד.",
    entryBar: "medium",
    entryNote:
    ...
    status: "active",
    notes:
      "אומת 19.8.2026 מול runi.ac.il ומול צילום מסך של נתי. קרן אור מכסה אותו במלואו. ללא נתוני שכר — ראה caveat.",
  },
  {
    ...
    status: "active",
    notes:
      "אומת 19.8.2026 מול runi.ac.il. קרן אור מכסה אותו במלואו. ללא נתוני שכר — ראה caveat.",
  },
];
