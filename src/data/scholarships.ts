...
export type Funding = {
  ...
  /**
   * שעות ההתחייבות בשנה — התנדבות, חונכות, מפגשים וסמינרים.
   *
   * הנתון הזה קיים בכל מלגה ואף אחד לא סופר אותו יחד. רוטשילד דורשת
   * עשר שעות שבועיות, ISEF שעתיים, פר״ח מאה שעות — ומי שצובר שלוש
   * מלגות מתחייב ליותר ממה שיש לו, ונשבר באמצע השנה. **זה בדיוק סוג
   * הדבר שנגלה בדיעבד**, ולכן הוא נשמר כמספר ולא כטקסט חופשי.
   *
   * נשמר שנתי ולא שבועי כדי שלא יתערבבו יחידות; ההמרה לשבועי נעשית
   * בתצוגה לפי 40 שבועות אקדמיים.
   */
  annualHours?: number;
  /**
...
/**
 * שכר הלימוד המתוקצב לשנה. הנתון היחיד שחוזר זהה בכל המוסדות
 * המתוקצבים שנבדקו, ולכן אפשר להציג אותו כעוגן לחשבון.
 *
 * תשפ״ז — נקבע אחרי מדד יולי, פורסם 15.8.2026. 12,017 היה נכון לתשפ״ו בלבד.
 * מלגה שמכסה שנה ראשונה מלאה מצביעה על הקבוע הזה ולא מקלידה מספר —
 * ב-28.8 התברר שפריפריה 45 נשארה על 12,017 שלמה אחרי שהמספר עודכן.
 */
...
export const FUNDING: Funding[] = [
  // ─── מלגות ─────────────────────────────────────────────────────────────────
  {
    ...
    kind: "scholarship",
    closesAt: { d: 15, m: 8 },
    what: "מלגה לסטודנטים שגרים בפריפריה ולומדים במוסד מתוקצב — שנה א׳ במימון מלא.",
    amount: BUDGETED_TUITION,
    amountNote: "שכר הלימוד המלא של שנה א׳ במוסד מתוקצב",
    catch:
  ...
  },
  {
    ...
    docs: ["id", "enrollment"],
    verified: "11.8.2026",
    annualHours: 100, // 100 שעות חונכות בשנה
  },
  {
    id: "mushal",
    name: "מלגת מושל",
...

  {
    ...
    opensAt: { d: 3, m: 8 },
    amount: BUDGETED_TUITION,
    amountNote: "עד 100% משכר הלימוד האוניברסיטאי של שנה א׳. מועבר לפיקדון עד 31.3.2027",
...

  {
    ...
    docs: ["id", "income", "enrollment"],
    /*
     * אומת 19.8.2026 מול apps.rothschildcp.com.
     *
     * הסכום הגדול ביותר שיש לנו — וגם המחיר הגבוה ביותר בזמן.
     * עשר שעות שבועיות מעל הלימודים אינן פרט — הן מוציאות מהמשחק
     * את מי שענה בשאלון "5–10 שעות בשבוע", וזה חלק גדול מהקהל שלנו.
     */
    amount: 20000,
    amountNote: "לשנה, לשלוש שנות התואר — סה״כ 60,000 ₪. באונו: 14,000 ₪ לשנה",
    closesAt: { m: 8, d: 31 },
    // פתוחה לכל תחום לימוד במוסדות המשתתפים — לא מוגבלת לתארים
    openToAllDegrees: true,
    institutions: ["huji", "tau", "mta", "bgu", "sce-ashdod", "sapir", "haifa", "technion", "tel-hai", "ono", "bar-ilan"],
    catch:
      "עשר שעות שבועיות מעל הלימודים: מפגש קבוצתי של ארבע שעות, ארבע עד שמונה שעות התנסות חברתית, ושלושה סמינרים בשנה. דורשת גם שלוש שנות תואר מלאות שנותרו.",
    verified: "19.8.2026",
    annualHours: 400, // עשר שעות שבועיות × 40 שבועות
  },
  {
    id: "isef",
    name: "ISEF",
    ...
    tracks: ["degree"],
    link: "https://www.isef.org.il/מלגות-לסטודנטים/",
    status: "active",
    ...
    docs: ["id", "income", "enrollment"],
    verified: "19.8.2026",
    // אומת 19.8.2026 מול isef.org.il. הסכומים אינם מפורסמים בדף הכללי
    opensAt: { m: 6, d: 1 },
    closesAt: { m: 7, d: 31 },
    catch:
      "מחייבת שעתיים שבועיות של עשייה בקהילה לאורך כל התואר, והשתתפות בתוכנית מנהיגות. זה לא קטן — שווה לבדוק שזה מסתדר עם ההתחייבויות של מלגות אחרות (פר״ח דורשת 100 שעות חונכות).",
    annualHours: 80, // שעתיים שבועיות × 40 שבועות
  },
  {
  ...
  },
  {
    ...
    tracks: ["degree"],
    closesAt: { d: 10, m: 9 },
    what: "מלגה לתחומי הנדסה, סביבה, אנרגיה ומקצועות טכנולוגיים — משנה ב׳ ומעלה.",
    catch:
      "**מוגבלת גיאוגרפית**: רק תושבי חדרה, זכרון יעקב, דלית אל-כרמל ויישובי חוף הכרמל, שלוש שנות מגורים לפחות. וההתחייבות כבדה — 120 שעות התנדבות בשנה בבוסתן טום, כולל ימי הכשרה. התשלום בשתי פעימות, אחרי 60 שעות ואחרי 120.",
    amount: 11000,
    amountNote: "לתואר ראשון משנה ב׳. לתואר שני — עד 14,000 ₪",
    annualHours: 120,
    link: "https://leviathanproject.co.il/scholarships/",
    status: "active",
    verified: "19.8.2026",
    notes: "אומת 19.8.2026 מהאתר. לפחות 40% מהמלגות לנשים.",
    docs: ["id", "enrollment"],
  },
  {
    id: "poalim-success",
    ...
    tracks: ["degree", "mahat"],
    closesAt: { d: 30, m: 8 },
    what: "מלגה עם תוכנית פיתוח קריירה והתנסות מעשית, בשיתוף בנק הפועלים וחינוך למצוינות.",
    catch:
      "**רק 120 מלגות בשנה בכל הארץ.** משנה ב׳ או ג׳ בלבד. ההתחייבות: כ-140 שעות בשנה — כ-100 שעות חונכות ילדים ונוער ב-55 מרכזי מצוינות, ועוד כ-40 שעות פיתוח קריירה. השנה יש עדיפות למשרתי מילואים ולפריפריה.",
    amount: 10000,
    annualHours: 140,
    link: "https://www.e4e.org.il/poalim-for-success/",
    status: "active",
    verified: "19.8.2026",
    notes: "אומת 19.8.2026. פתוחה גם למכללות הנדסה מוכרות.",
    docs: ["id", "enrollment", "grades"],
  },
  {
    id: "derech-ami",
    name: "דרך עמ\"י",
    ...
    tracks: ["degree"],
    opensAt: { d: 18, m: 8 },
    what: "מלגה תמורת ערב לימוד שבועי באחד מ-23 המרכזים ברחבי הארץ. אינה תלויה בתחום הלימוד.",
    catch:
      "**תוכנית זהות יהודית** — הערב השבועי עוסק ביהדות, מסורת ומורשת, וזה תנאי המלגה ולא תוספת. גילאי 20–35, בוגרי החינוך הממלכתי. הקבלה כוללת ראיון.",
    amount: 10000,
    amountNote: "עד 10,000 ₪ — משתנה לפי מרכז, ובחלקם 5,000 ₪",
    annualHours: 120,
    link: "https://amiway.org.il/registration/",
    status: "active",
    verified: "19.8.2026",
    notes: "אומת 19.8.2026. השעות מוערכות מ״ערב בשבוע״ ולא פורסמו כמספר.",
    docs: ["id", "enrollment"],
  },
  {
    id: "nefesh-yehudi",
    ...
    kind: "scholarship",
    tracks: ["degree"],
    what: "מלגה שנתית תמורת מפגשים שבועיים בנושאי תרבות יהודית, צמיחה אישית וזוגיות.",
    catch:
      "**138 שעות בשנה** — ההתחייבות הכבדה ביותר מבין מלגות הזהות. תוכן התוכנית הוא לימודי יהדות, וזה תנאי ולא תוספת.",
    amount: 10000,
    amountNote: "נע בין 5,000 ל-10,000 ₪ לשנה, לפי מרכז",
    annualHours: 138,
    link: "https://www.study.co.il/P45542/",
    status: "needs-check",
    verified: "19.8.2026",
    notes: "אומת 19.8.2026 ממקורות משניים בלבד — 📞 לאמת סכום ותאריכים מול התוכנית עצמה.",
    docs: ["id", "enrollment"],
  },
  {
    id: "chabad-campus",
    ...
    kind: "scholarship",
    tracks: ["degree"],
    what: "מלגה תמורת 15 מפגשי יהדות בשנה, כשעה וחצי כל מפגש. קיימת כמעט בכל מוסד בארץ.",
    catch:
      "**ההתחייבות הקלה מכל מלגות הזהות** — כ-22 שעות בשנה בסך הכל. בתמורה גם הסכום הנמוך ביותר. תוכן המפגשים הוא לימודי יהדות.",
    amount: 1500,
    amountNote: "משתנה בין מוקדים — במקומות מסוימים 800 ₪",
    annualHours: 22,
    link: "https://chabadbacampus.co.il/",
    status: "active",
    verified: "19.8.2026",
    notes: "אומת 19.8.2026 ממקורות משניים. הסכום משתנה בין קמפוסים.",
    docs: ["id", "enrollment"],
  },
  {
    id: "taltan-scholarship",
    name: "תלתן",
    kind: "scholarship",
    what: "לא אותרה. נתי הזכיר אותה, ולא נמצאו שם מדויק, אתר או פרטים.",
    status: "hidden", // מוסתר עד אימות — לא מציגים למועמד מה שאיננו יודעים
    notes: "🔍 חסר שם מדויק או קישור. מוסתר עד שיאותר — לא מציגים למועמד מה שאיננו יודעים.",
    docs: [],
  },
  {
    id: "or-lachinuch",
    name: "אור לחינוך",
    kind: "scholarship",
    what: "מלגה של עמותת אור. הפרטים לא נקראו.",
    link: "https://www.ore.ngo/",
    status: "hidden", // מוסתר עד אימות — לא מציגים למועמד מה שאיננו יודעים
    notes: "🔍 האתר מחזיר 403 ולא ניתן לקריאה אוטומטית (נבדק 19.8.2026). 📞 לברר טלפונית או בדפדפן.",
    docs: [],
  },
  {
    id: "hamakom",
    name: "המקום — תרבות ורוח",
    kind: "scholarship",
    what: "לא אותרה בחיפוש. סביר שזו תוכנית זהות/תרבות עם מלגה, כמו דרך עמ״י ונפש יהודי.",
    status: "hidden", // מוסתר עד אימות — לא מציגים למועמד מה שאיננו יודעים
    notes: "🔍 לא נמצאה ברשת בשם הזה (נבדק 19.8.2026). צריך קישור או שם מדויק.",
    docs: [],
  },
];
